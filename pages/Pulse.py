...
def show():
    ...
    **Expansion**, **Renewal**, **Adoption** and **Risky**.  
    ...
    def metric_card(title, value, delta=None):
        ...
        return f"""
        <div style="border:1px solid #e0e0e0; padding:5px; border-radius:6px; background-color:#f9f9f9; width: 100%; margin-bottom:1px">
            <h6 style="margin-bottom:0">{title}</h8>
            <p style="font-size: 20px; font-weight: bold; margin:1px 0">{value}</p>
            {delta_str}
        </div>
        """
